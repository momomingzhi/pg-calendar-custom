    ...
    value: function setup() {
      this.$state = {
        ...
        items: [{
          ...
          option: {
            disabledDates: [(0, _moment.default)().add(-1, 'd').format('YYYY-MM-DD')]
          }
        }, {
          title: '주말 선택 불가하게 하기',
          ...
          option: {
            format: 'YYYY.MM.DD',
            disabledDates: [(0, _moment.default)().format('YYYY-MM-DD')]
          }
        }, {
          ...
          option: {
            minDate: (0, _moment.default)().add(-1, 'd').format('YYYY-MM-DD'),
            maxDate: (0, _moment.default)().add(7, 'd').format('YYYY-MM-DD')
          }
        }, {
          title: '한주 단위로 선택하기',
          className: "oneWeek",
